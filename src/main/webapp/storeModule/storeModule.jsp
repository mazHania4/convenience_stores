...
<body>
<!-- header -->
<header class="banner overlay bg-cover" data-background="${pageContext.request.contextPath}/images/storebanner.jpg">
    <!-- navBar -->
    ...
    <div class="container section">
        <div class="row">
            <div class="col-lg-8 text-center mx-auto">
                <h1 class="text-white mb-3">Módulo de tienda</h1>
            </div>
        </div>
    </div>
    <!-- /banner -->
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-4 col-sm-6 mb-4">
                <a href="#" class="px-4 py-5 bg-white shadow text-center d-block match-height">
                    <i class="ti-list icon text-primary d-block mb-4"></i>
                    <h3 class="mb-3 mt-0">Pedido</h3>
                    <p class="mb-0">Crear o editar un pedido</p>
                </a>
            </div>
            <div class="col-lg-4 col-sm-6 mb-4">
                <a href="#" class="px-4 py-5 bg-white shadow text-center d-block match-height">
                    <i class="ti-import icon text-primary d-block mb-4"></i>
                    <h3 class="mb-3 mt-0">Envío</h3>
                    <p class="mb-0">Recibir un envío</p>
                </a>
            </div>
            <div class="col-lg-4 col-sm-6 mb-4">
                <a href="#" class="px-4 py-5 bg-white shadow text-center d-block match-height">
                    <i class="ti-alert icon text-primary d-block mb-4"></i>
                    <h3 class="mb-3 mt-0">Incidencia</h3>
                    <p class="mb-0">Crear una incidencia</p>
                </a>
            </div>
            <div class="col-lg-4 col-sm-6 mb-4">
                <a href="#" class="px-4 py-5 bg-white shadow text-center d-block match-height">
                    <i class="ti-reload icon text-primary d-block mb-4"></i>
                    <h3 class="mb-3 mt-0">Devolución</h3>
                    <p class="mb-0">Crear una devolución</p>
                </a>
            </div>
        </div>
    </div>
