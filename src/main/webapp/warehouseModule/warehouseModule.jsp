...
<html>
<head>
    <title>Módulo de bodega central</title>
...
<body>
<!-- header -->
<header class="banner overlay bg-cover" data-background="${pageContext.request.contextPath}/images/warehousebanner.jpg">
    <!-- navBar -->
    ...
    <div class="container section">
        <div class="row">
            <div class="col-lg-8 text-center mx-auto">
                <h1 class="text-white mb-3">Módulo de bodega central</h1>
            </div>
        </div>
    </div>
    <!-- /banner -->
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-4 col-sm-6 mb-4">
                <a href="#" class="px-4 py-5 bg-white shadow text-center d-block match-height">
                    <i class="ti-export icon text-primary d-block mb-4"></i>
                    <h3 class="mb-3 mt-0">Envío</h3>
                    <p class="mb-0">Crear o editar un envío</p>
                </a>
            </div>
            <div class="col-lg-4 col-sm-6 mb-4">
                <a href="#" class="px-4 py-5 bg-white shadow text-center d-block match-height">
                    <i class="ti-check icon text-primary d-block mb-4"></i>
                    <h3 class="mb-3 mt-0">Incidencia</h3>
                    <p class="mb-0">Solucionar una incidencia</p>
                </a>
            </div>
            <div class="col-lg-4 col-sm-6 mb-4">
                <a href="#" class="px-4 py-5 bg-white shadow text-center d-block match-height">
                    ...
                    <p class="mb-0">Aceptar o rechazar una devolución</p>
                </a>
            </div>
        </div>
    </div>
