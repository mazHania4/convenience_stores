...
<html>
<head>
    <title>Editar usuario de tienda</title>
...
<body>
    ...
    <section class="section pb-0">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2 class="section-title text-primary">Crear o editar usuarios de tienda</h2>
                            ...
                            <div id="create-user" class="collapse" data-parent="#accordion">
                                <div class="card-body font-secondary text-color">
                                    <form action="${pageContext.request.contextPath}/manage-user-servlet" method="POST">
                                        ...
                                        <input type="hidden" id="newUserType" name="newUserType" value="store_user">
                                        <!-- storeId input -->
                            ...
                            <div id="edit-user" class="collapse" data-parent="#accordion">
                                <div class="card-body font-secondary text-color">
                                    <table>
                                        ...
                                        <tbody>
                                        <c:forEach items="${storeUsers}" var="stUser">
                                            <tr>
                                                <td><strong>${stUser.id}</strong></td>
                                                <td><strong>${stUser.store.id}</strong></td>
                                                <td><em>${stUser.name}</em></td>
                                                <td><em>${stUser.username}</em></td>
                                                <td><em>${stUser.email}</em></td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    </table>
                                    <form action="${pageContext.request.contextPath}/manage-user-servlet" method="POST">
                                        <!-- hidden UserType input -->
                                        <input type="hidden" id="userType" name="userType" value="store_user">
                                        <!-- UserId input -->
                                        <input type="text" name="userId" id="userId" placeholder="Id del usuario a modificar" class="form-control mb-4 shadow rounded-0"/>
                                        <!-- storeId input -->
                                        <input type="text" name="storeId" id="storeId" placeholder="Id de la tienda" class="form-control mb-4 shadow rounded-0"/>
                                        <!-- Name input -->
